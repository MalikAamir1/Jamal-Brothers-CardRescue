...
export default function InputWithCalenderWithDropdown(props) {
  ...
  const [selectedYear, setSelectedYear] = useState(new Date().getFullYear()); // Initial selected year
  ...
  const handleYearChange = year => {
    ...
    const newMarkedDates = {selectedYear}; // Create a new object for marked dates of the selected year
    // Logic to populate newMarkedDates based on the selected year, e.g., events or holidays
